...
SWITCH_MAPPING = {
    # Port P1 Mappings
    "EIO0": {"switch": "S0", "psu": "P1"},
    "EIO1": {"switch": "S1", "psu": "P1"},
    "EIO2": {"switch": "S2", "psu": "P1"},
    "EIO3": {"switch": "S3", "psu": "P1"},
    "EIO4": {"switch": "S4", "psu": "P1"},
    "EIO5": {"switch": "S5", "psu": "P1"},
    "EIO6": {"switch": "S6", "psu": "P1"},
    "EIO7": {"switch": "S7", "psu": "P1"},
    "CIO0": {"switch": "S8", "psu": "P1"},
    "CIO1": {"switch": "S9", "psu": "P1"},
    "CIO2": {"switch": "S10", "psu": "P1"},
    "CIO3": {"switch": "S11", "psu": "P1"},
    # psu P2 Mappings
    "FIO0": {"switch": "S0", "psu": "P2"},
    "FIO1": {"switch": "S1", "psu": "P2"},
    "FIO2": {"switch": "S2", "psu": "P2"},
    "FIO3": {"switch": "S3", "psu": "P2"},
    "FIO4": {"switch": "S4", "psu": "P2"},
    "FIO5": {"switch": "S5", "psu": "P2"},
    "FIO6": {"switch": "S6", "psu": "P2"},
    "FIO7": {"switch": "S7", "psu": "P2"},
    "DAC0": {"switch": "S8", "psu": "P2"},
    "DAC1": {"switch": "S9", "psu": "P2"},
    "MIO0": {"switch": "S10", "psu": "P2"},
    "MIO1": {"switch": "S11", "psu": "P2"},
    # psu P3 Mappings
